...
namespace ProjetoWebMvc.Data
{
    public class SeedingService
    {
        ...
        // criando um construtor que recebe um objeto do tipo _context
        // pra indicar que a injeção de dependencia deve acontecer
        public SeedingService(ProjetoWebMvcContext context)
        {
            _context = context;
        }
        
        // operação resposavel por popular a base de dados
        public void Seed()
        {
            // testando se ja existe um dado na base da dados
            ...
            Department d3 = new Department(3, "Fshion");
            Department d4 = new Department(4, "Books");

            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Alex Silva", "Alesilva@gmail.com", new DateTime(1990, 3, 19), 3200.0, d2);
            Seller s3 = new Seller(3, "Marcos Mion", "Mion@gmail.com", new DateTime(1980, 6, 23), 2230.0, d1);
            Seller s4 = new Seller(4, "Claudia Leite", "Claudia@gmail.com", new DateTime(1985, 2, 20), 4000.0, d4);
            Seller s5 = new Seller(5, "Thiago Liefer", "ThiagoL@gmail.com", new DateTime(1993, 8, 11), 5500.0, d3);
            Seller s6 = new Seller(6, "Romulu Cardoso", "Romulu@gmail.com", new DateTime(2000, 1, 3), 2500.0, d2);
